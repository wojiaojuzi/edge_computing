...
public class Prisoner {
    ...
    private String prisonerPhotoUri;
    ...
    public String getPrisonerPhotoUri() {
        return prisonerPhotoUri;
    }

    public void setPrisonerPhotoUri(String prisonerPhotoUri) {
        this.prisonerPhotoUri = prisonerPhotoUri;
    }
    ...
    public String toString() {
        return "Prisoner{" + "id=" + id + ", prisonerName=" + prisonerName + "}";
    }
